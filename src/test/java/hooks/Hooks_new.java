...
public class Hooks_new {
    ...
    public void beforeScenario(Scenario scenario) {
        ...
        if (tags.contains("@web")) {
            ...
            String csrfToken = authApi.getCsrfToken();
            String sessionValue = authApi.getSessionValue();
            ...
            WebDriverRunner.getWebDriver().manage().addCookie(new Cookie("session", sessionValue));
